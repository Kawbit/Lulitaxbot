...
if wget -q https://github.com/Kawbit/Lulitaxbot/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/Kawbit/Lulitaxbot.git
